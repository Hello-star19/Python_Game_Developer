...
def create_satellites(): 
    ...
    for count in range(0, number_of_satellite): 
        ...
        # Scale the image (increase size by 1.5x) 
        satellite._surf = pygame.transform.scale(satellite._surf, (satellite.width * 1.25, satellite.height * 1.25)) 
        satellite.width, satellite.height = satellite._surf.get_size() 
        # Update Actor size 
