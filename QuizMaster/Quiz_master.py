...
# creates sizes and dimensions of the box
...
score = 0
time_left = 10
question_file_name = "/Users/Mahid/Desktop/JetLearn/questions.txt"
marquee_messaage = ""
is_game_over = False # checks if game is still in motion
answer_boxes = [answer_box1, answer_box2,answer_box3, answer_box4]
questions = []
question_count = 0
question_index = 0  # itertive way we can move from one count to another



# Creates location of boxes
