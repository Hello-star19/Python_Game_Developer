# yellow_spaceship_img = pygame.image.load("C:/Users/Mirza/Desktop/JetLearn/Python_Game_Developer/images/spaceship_yellow.png")
# yellow_spaceship = pygame.transform.rotate(pygame.transform.scale(yellow_spaceship_img, (spaceship_width, spaceship_height)), 90)

# red_spaceship_img = pygame.image.load("C:/Users/Mirza/Desktop/JetLearn/Python_Game_Developer/images/spaceship_red.png")
# red_spaceship = pygame.transform.rotate(pygame.transform.scale(red_spaceship_img, (spaceship_width, spaceship_height)), 270)
# space = pygame.transform.scale(pygame.image.load("C:/Users/Mirza/Desktop/JetLearn/Python_Game_Developer/images/background.png"), (WIDTH, HEIGHT))

# C:/Users/Mirza/Desktop/JetLearn/Python_Game_Developer/images/background.png

import pygame
import os

pygame.init() #initilaises component in game
pygame.mixer.init() #

WIDTH = 900      #Sets screen dimensions
HEIGHT = 500

screen = pygame.display.set_mode((WIDTH, HEIGHT)) # Creates screen

White = (255, 255, 255)  # Assighns colour to colour variables
Black = (0, 0, 0)
Red_color = (255, 0, 0)
Yellow_color = (255, 255, 0)

border = pygame.Rect(WIDTH // 2 -5, 0, 10, HEIGHT) # Creates border in game
healthFont = pygame.font.SysFont("comicsans", 40)   # Create heaings
...
bullet_vel = 7
max_bullets = 4
spaceship_width, spaceship_height = 55, 40 # dimensions of ship
...
def draw_window(Red, Yellow, Red_color, Yellow_color, Red_Bullets, Yellow_bullets, Red_health, Yellow_health):
    screen.blit(space, (0, 0)) # .blit effects background image
...
def handle_bullets(yellow_bullets, red_bullets, yellow, red):
    for bullet in yellow_bullets:
        bullet.x += bullet_vel
        if red.colliderect(bullet): # checks if red space ship touches yellow bullet
